...
export default {
    ...
    methods:{
        detail(){
            ...
            this.$http.get(
                this.ports+'/histories/process-instances/'+this.selectData[0].procInstId,
                {procInsId:this.selectData[0].procInstId},
                data=>{
                   this.config.data=data
                   this.$http.get(
                       this.ports+'/runtime/process-instances/images/'+this.selectData[0].procInstId,
                       {procInsId:this.selectData[0].procInstId},
                       data=>{
                           this.active='0'
        ...
        getList(){
            this.$http.get(
                this.ports+'/runtime/executions/ruSelfProclist',
                {
